...
const CARDS = [
  ...
  { id:'girasoli', name:'Girasoli', type:'object', color:'yellow', trait:'Senza scritta', image:'/assets/cards/girasoli.jpg' },
  ...
  { id:'nippon', name:'Nippon', type:'object', color:'blue', trait:'Con scritta', image:'/assets/cards/nippon.jpg' },
  ...
  { id:'dipinto', name:'Dipinto', type:'object', color:'pink', trait:'Senza scritta', image:'/assets/cards/dipinto.jpg' },
  ...
  { id:'occhiali', name:'Occhiali da sole', type:'object', color:'purple', trait:'Senza scritta', image:'/assets/cards/occhiali.jpg' },
  ...
  { id:'collana', name:'Collana', type:'object', color:'green', trait:'Con scritta', image:'/assets/cards/collana.jpg' },
  ...
  { id:'diario', name:'Diario di coppia', type:'object', color:'red', trait:'Con scritta', image:'/assets/cards/diario.png' }
];
...
io.on('connection', socket => {
  ...
  socket.on('askQuestion', ({ kind, value, side } = {}, ack = () => {}) => {
    ...
    const allowedTraits = ['Uomo', 'Donna', 'Capoluogo', 'Non capoluogo', 'Con scritta', 'Senza scritta'];
